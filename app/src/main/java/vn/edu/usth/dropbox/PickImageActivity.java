...
//        getSupportActionBar().setHomeButtonEnabled(true);
        ...
        mSelectedIv =  findViewById(R.id.iv);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (data != null && data.getData() != null && resultCode == RESULT_OK) {
            ...
            SharedPreferences sp_uri = PickImageActivity.this.getSharedPreferences("uri_getSP", Context.MODE_PRIVATE);
            ...
            if (isImageFromGoogleDrive) {
                ...
                SharedPreferences sp_clicked = PickImageActivity.this.getSharedPreferences("IMAGEPATH", Context.MODE_PRIVATE);
